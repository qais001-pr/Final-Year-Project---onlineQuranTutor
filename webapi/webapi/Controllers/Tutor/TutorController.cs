        ...
        public HttpResponseMessage addTutor()
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(tutor.name.Trim()) ||
                    ...
                    string.IsNullOrEmpty(tutor.name.Trim()) ||
                ...
                if (postedFile != null && postedFile.ContentLength > 0)
                {
                    ...
                    tutor.profile = "/UploadedTutorImages/" + fileName.ToString();
                }
                ...
                foreach (var item in tutor.subjectList)
                {
                    ...
                    {
                        Subject = _context.Subjects.Where(s => s.subjectID == item.subjectID).FirstOrDefault(),
